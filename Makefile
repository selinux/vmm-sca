...
payload.o: payload.ld guest16.o guest32.img.o guest64.img.o page.img.o
	$(LD) -r -T $< -o $@
...
page.img:
	dd if=/dev/zero of=page.img bs=4k count=1
...
clean:
	$(RM) kvm-hello-world kvm-hello-world.o payload.o guest16.o \
		...
		guest64.o guest64.img guest64.img.o page.img page.img.o
